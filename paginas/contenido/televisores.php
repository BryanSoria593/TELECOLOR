...
<head>
    ...
    <link rel="stylesheet" href="../../styles/paginas/televisores.css">
             ...
             <section class="containerOfertas">
                ...
                <div class="productosOfertas" id="televisoresOfertas">
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor7.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>TELEVISOR VIZIO</h3>
                            <p class="productos__informacion">SMART TV | 4K | UHD</p>
                            <p class="precioAntiguo">$487.99</p>
                    ...
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor8.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>TELEVISOR SAMSUNG</h3>
                            <p class="productos__informacion">40'' | FHD | 1080P</p>
                            <p class="precioAntiguo">$280.99</p>
                    ...
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor9.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>TELEVISOR TCL</h3>
                            <p class="productos__informacion">32'' | HD LED | 4K</p>
                            <p class="precioAntiguo">$180.99</p>
                    ...
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor10.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>TELEVISOR SAMSUNG</h3>
                            <p class="productos__informacion">50'' | 4K | UHD</p>
                            <p class="precioAntiguo">$440.99</p>
                    ...
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor11.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>TELEVISIÓN HISENSE</h3>
                            <p class="productos__informacion">ZOOM | SKYPE | TEAMS</p>
                            <p class="precioAntiguo">$420.99</p>
                    ...
                    <div class="productosOfertas__items">
                        <picture>
                            <img src="../../img/televisores/televisor12.jpg" alt="Imágen de TV ROKU">
                        </picture>
                        <div class="productos__descripcion">
                            <h3>LG 65UP8000PUR</h3>
                            <p class="productos__informacion">SMART TV | 65''</p>
                            <p class="precioAntiguo">$690.99</p>
