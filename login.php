    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-9 col-lg-6 col-xl-5">
          <img src="img/LOGO.png" class="img-fluid" alt="Logotipo TELECOLOR">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form>
            ...
            <div class="form-outline mb-4">
              <input type="email" id="form3Example3" class="form-control form-control-lg" placeholder="Ingrese su correo electrónico" />
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              <button type="button" class="login btn btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Iniciar sesión</button>
              <p class="small fw-bold mt-2 pt-1 mb-0">¿Aún no tienes cuenta? <a href="registrer.php" class="link-danger">Regístrate</a></p>
            </div>
